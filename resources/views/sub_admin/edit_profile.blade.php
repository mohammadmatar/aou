        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="b-form">
                    ...
                    <hr class="b-hr" />
                    <form action="{{url('/sadmin/editprofile')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="b-form-row b-form-inline b-form-horizontal">
                            <div class="col-md-12 col-md-offset-2">
                                <div class="b-form-row">
                                    <label class="b-form-horizontal__label" for="create_account_email">Sub Admin ID</label>
                                    <div class="b-form-horizontal__input">
                                        <input type="text" value="{{auth()->guard('subadmin')->user()->sub_admin_id}}" required="" name="sub_id" id="create_account_email" readonly="" class="form-control"
                                        />
                                    </div>
                                </div>

                                <input type="hidden" value="{{auth()->guard('subadmin')->user()->id}}" required="" name="sid" />
                                <input type="hidden" value="{{auth()->guard('subadmin')->user()->email}}" required="" name="email" />

                                <div class="b-form-row">
                                    <label class="b-form-horizontal__label" for="create_account_email">Email</label>
                                    <div class="b-form-horizontal__input">
                                        <input type="text" value="{{auth()->guard('subadmin')->user()->email}}" name="email" id="email" class="form-control" disabled/>
                                    </div>
                                </div>
                                ...
                                <div class="b-form-row">
                                    ...
                                    <div class="b-form-horizontal__input">
                                        <input type="text" value="{{auth()->guard('subadmin')->user()->name}}" name="name" id="name" class="form-control" />
                                    </div>
                                </div>
                                ...
                                <div class="b-form-row">
                                    ...
                                    <div class="b-form-horizontal__input">
                                        <input type="text" value="{{auth()->guard('subadmin')->user()->phone_number}}" name="phone_number" id="phone_number" class="form-control" />
                                    </div>
                                </div>
                                ...
                                <div class="b-form-row">
                                    ...
                                    <div class="b-form-horizontal__input">
                                        <input type="text" required="" value="{{auth()->guard('subadmin')->user()->address}}" name="address" id="address" class="form-control" />
                                    </div>
                                </div>
                                ...
                                <div class="b-form-row">
                                    ...
                                    <div class="b-form-horizontal__input">
                                        <textarea class="form-control" id="summary" required="" name="summary" placeholder="Summary" rows="5">{{auth()->guard('subadmin')->user()->summary}}</textarea>
                                    </div>
                                </div>
