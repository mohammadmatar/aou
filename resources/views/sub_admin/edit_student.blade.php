...
@section('title') Edit Student | AOU
@endsection
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="b-form">
                    ...
                    <hr class="b-hr" /> @if(auth()->guard('subadmin')->user())
...
{{--                                         <label class="b-form-horizontal__label" for="create_account_email">Student ID</label> --}}
                                    ...
                                    <div class="b-form-row">
                                        ...
                                        <div class="b-form-horizontal__input">
                                            <input type="text" required="" name="phone_number" value="{{$std->phone_number}}" id="create_account_email" class="form-control"
                                            />
                                        </div>
                                    </div>
