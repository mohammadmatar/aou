    ...
    <div class="b-breadcrumbs f-breadcrumbs">
        <div class="container">
            <ul>
                ...
                <li><i class="fa fa-angle-right"></i><span>Add Student</span></li>
            </ul>
        </div>
    </div>
    ...
    @endif
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="b-form">
                    <div class="f-primary-l f-title-big c-secondary">Add Student</div>
                    <hr class="b-hr" />
                    @if(auth()->guard('subadmin')->user())
                    <form action="{{url('/sadmin/savstd')}}" method="post" enctype="multipart/form-data">
                      @endif
                      @if(auth()->guard('instructor')->user())
                    <form action="{{url('/instr/savstd')}}" method="post" enctype="multipart/form-data">
                      @endif
                    ...
                    <div class="b-form-row b-form-inline b-form-horizontal">
                        <div class="col-md-12 col-md-offset-2">
                            ...
                            <div class="b-form-row">
                                ...
                                <div class="b-form-horizontal__input">
                                    <input type="text" value="{{App\Student::max('student_id')+1}}" required="" name="student_id" id="create_account_email" readonly="" class="form-control" />
                                </div>
                            </div>
                            ...
                            <div class="b-form-row">
                                ...
                                <div class="b-form-horizontal__input">
                                    <input type="text" required="" name="phone" id="create_account_email" class="form-control" />
                                </div>
                            </div>
                        ...
                        @endforeach
                            ...
                            <div class="b-form-row">
                                ...
                                <div class="b-form-horizontal__input">
                                    <input type="text" required="" name="level" id="create_account_email" class="form-control" />
                                </div>
                            </div>
