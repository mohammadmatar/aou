          ...
          <div class="b-shortcode-example f-center">
            <div class="b-mention-item b-mention-item--vertically">
              <div class="b-mention-item__user_img" style="height: 120px; width: 120px;">
                <img  class="fade-in-animate" data-retina src="/sub_admins/{{$profile->img}}" alt="">
              </div>
              <div class="b-mention-item__comment">
                ...
                <div class="b-mention-item__comment_text f-mention-item__comment_text"> You Branch: @if(!empty(App\Branch::where('sub_admin_id',$profile->id)->first()->name))
                  {{App\Branch::where('sub_admin_id',$profile->id)->first()->name}}
                @endif
                </div>
