...
@section('title') Student login | AOU
@endsection
        ...
        <div class="b-shortcode-example">
            <div class="b-alert-warning f-alert-warning">
                ...
                <div class="b-remaining">
                    ...
                    , Click to <a href="/resendConfirm/{{session()->get('email')}}"> Resend</a> the confirmation Email
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="b-log-in-form">
                    ...
                    <hr class="b-hr" />
                    <form action="{{url('/check/student')}}" method="post">
                        {{csrf_field()}}
