          ...
          <div class="b-shortcode-example f-center">
            <div class="b-mention-item b-mention-item--vertically">
              ...
              <div class="b-mention-item__comment">
                ...
                <div class="b-mention-item__comment_text f-mention-item__comment_text"> Your ID: 
                  {{$profile->student_id}}
               
                </div>

                <div class="b-mention-item__comment_text f-mention-item__comment_text"> Your Level: 
                  {{$profile->level}}
               
                </div>

                <div class="b-mention-item__comment_text f-mention-item__comment_text"> Your Branch: @if(!empty(App\Branch::where('id',$profile->branch_id)->first()->name))
