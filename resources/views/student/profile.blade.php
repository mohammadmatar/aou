...
@section('title') Student Profile | AOU
@endsection
      ...
      <div class="b-shortcode-example f-center">
        <div class="b-mention-item b-mention-item--vertically">
          <div class="b-mention-item__user_img" style="height: 120px; width: 120px;">
            <img data-retina src="/img/students/{{$profile->img}}" alt="">
          </div>
          <div class="b-mention-item__comment">
            ...
            <div class="b-mention-item__comment_text f-mention-item__comment_text"> Level: {{$profile->level}} </div>
            <div class="b-mention-item__comment_text f-mention-item__comment_text"> Branch: @if(!empty(App\Branch::where('id',$profile->branch_id)->first()->name)) {{App\Branch::where('id',$profile->branch_id)->first()->name}}
              @endif
            </div>
          </div>
        </div>
