...
@if(auth()->guard('admin')->user())
                    <li class="b-top-nav__1level f-top-nav__1level <?php if($pg==1){echo 'is-active-top-nav__1level';}?> f-primary-b"><a href="{{url('/dashboard')}}"><i class="fa fa-home b-menu-1level-ico"></i>dashboard<span class="b-ico-dropdown">
@endif
                {{--     @if(auth()->guard('admin')->user())
