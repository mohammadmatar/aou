                    ...
                    <form action="{{url('/save/course')}}" method="post" enctype="multipart/form-data">
                        ...
                        @endforeach
                                ...
                                <div class="b-form-row">
                                    ...
                                    <div class="b-form-horizontal__input">
                                        <input type="text" required="" name="level" id="create_account_password" class="form-control" />
                                    </div>
                                </div>
                                <div class="b-form-row">
                                    <label class="b-form-horizontal__label" for="create_account_password">Hours</label>
                                    <div class="b-form-horizontal__input">
                                        <input type="text" required="" name="hours" id="create_account_password" class="form-control" />
                                    </div>
                                </div>
                                ...
                                <div class="b-form-row">
                                    ...
                                    <div class="b-form-horizontal__input">
                                        <input type="text" required="" name="discount" id="create_account_password" class="form-control" />
                                    </div>
                                </div>
                                ...
                                <div class="b-form-row">
                                    ...
                                    <div class="b-form-horizontal__input">
                                        <input type="text" required="" name="seats" id="create_account_password" class="form-control" />
                                    </div>
                                </div>
                                ...
                                <div class="b-form-row">
                                    ...
                                    <div class="b-form-horizontal__input">
                                        <input type="text" required="" name="duaration" id="create_account_password" class="form-control" />
                                    </div>
                                </div>
                                <div class="b-form-row">
