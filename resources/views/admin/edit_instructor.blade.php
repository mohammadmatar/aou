    ...
    @endif
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="b-form">
                    <div class="f-primary-l f-title-big c-secondary">Edit Instructor</div>
                    <hr class="b-hr" />
                    ...
                    <div class="b-form-row b-form-inline b-form-horizontal">
                        <div class="col-md-12 col-md-offset-2">
                          <div class="b-form-row">
                                ...
                                <div class="b-form-horizontal__input">
                                    <input type="text" value="{{$inst->instructor_id}}" required="" name="sub_id" id="create_account_email" readonly="" class="form-control" />
                                </div>
                            </div>

                                    <input type="hidden" value="{{$inst->id}}" required="" name="sid"   />
                            <div class="b-form-row">
                                <label class="b-form-horizontal__label" for="create_account_email">Name</label>
                                <div class="b-form-horizontal__input">
                                    <input type="text" required="" value="{{$inst->name}}" name="name" id="create_account_email" class="form-control" />
                                </div>
                            </div>
                            ...
                            <div class="b-form-row">
                                ...
                                <div class="b-form-horizontal__input">
                                    <input type="text" required="" value="{{$inst->Address}}" name="address" id="create_account_email" class="form-control" />
                                </div>
                            </div>
                      ...
                      <div class="b-form-row">
                            ...
                            <div class="b-form-row">
                                ...
                                <div class="b-form-horizontal__input">
                                    <textarea class="form-control" id="summary" required=""  name="summary" placeholder="Details" rows="5">{{$inst->summary}}</textarea>
                                </div>
                            </div>
