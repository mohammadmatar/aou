                        ...
                        <div class="col-md-12 col-md-offset-2">
                          <div class="b-form-row">
                                ...
                                <div class="b-form-horizontal__input">
                                    <input type="text" value="{{auth()->guard('admin')->user()->admin_id}}" required="" name="sub_id" id="create_account_email" readonly="" class="form-control" />
                                </div>
                            </div>
                            ...
                            <div class="b-form-row">
                                ...
                                <div class="b-form-horizontal__input">
                                    <input type="text" required="" value="{{auth()->guard('admin')->user()->Address}}" name="address" id="create_account_email" class="form-control" />
                                </div>
                            </div>
